...
class BookingDashboard extends Component {
  ...
  handlePickupButton() {
    ...
    BookingServiceApi.modifyBooking(this.state.nextBooking).then(() => {
      this.setState({
        ...
        successMsg:
          "Car has been picked up! Please return it before your specified return time.",
        availablePickup: false,
  ...
  handleReturnButton() {
    ...
    BookingServiceApi.modifyBooking(this.state.nextBooking).then(() => {
      this.setState({
        ...
        successMsg: "Car has been returned! Thanks for using Twim",
        avaialbleReturn: false,
      });
    });
  }
  ...
  componentDidMount() {
    ...
    BookingServiceApi.getNextBooking()
      .then((res) => {
        if (Object.keys(res.data).length) {
          ...
          this.setState({
            ...
            availablePickup:
              !(new Date(res.data.pickuptime) > currentTime) &&
          ...
          <div className='white-cards-div'>
            <Container>
              ...
              {this.state.isLoading && (
                <div id='garage-map' style={{ height: "400px" }}>
                  <Map
              ...
              <b>Booking time: </b> {this.state.nextBooking.bookedtime}{" "}
              <br></br>
              ...
              <Button href={`/mybookings/${this.state.nextBooking._id}`}>
                View Booking
              </Button>
              <Col sm={4}>
                <div
                ...
                >
                  ...
                  <p>
                    {this.state.car.fueltype}, {this.state.car.bodytype},{" "}
                    {this.state.car.seats} seaters, {this.state.car.colour}
                  </p>
