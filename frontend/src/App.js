    ...
    return (
      <Router>
        ...
        <Switch>
          ...
          {!isUserStaff && !isUserAdmin && <AuthenticatedRoute path="/filter" component={(props) => <FilterCarsPage {...props}
            availableCars={availableCars}
            pickupTime={pickupTime}
            returnTime={returnTime} />} />}
          {!isUserStaff && <AuthenticatedRoute path="/dashboard" component={(props) => <BookingDashboard {...props}
            updateCars={this.updateCars.bind(this)} />} />}
          {!isUserStaff && !isUserAdmin && <AuthenticatedRoute path="/mybookings/:id" component={BookingDetailsPage} />}
          {!isUserStaff && !isUserAdmin && <AuthenticatedRoute path="/mybookings" component={MyBookingPage} />}
          {!isUserStaff && !isUserAdmin && <AuthenticatedRoute path="/myprofile" component={MyProfilePage} />}
